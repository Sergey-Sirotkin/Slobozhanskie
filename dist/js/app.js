(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-slider")) new core(".main-slider__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".new-slider")) new core(".new-slider__slider", {
            ...
            on: {
                init: function() {
                    if (this.slides.length <= 4) {
                        ...
                        this.el.querySelector(".swiper-pagination-bullet-active").setAttribute("hidden", "");
                    }
                }
            }
        });
        if (document.querySelector(".bestsellers-slider")) new core(".bestsellers-slider__slider", {
            modules: [ Autoplay, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".about-slider")) new core(".about-slider__slider", {
            modules: [ Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".catalog-top-slider")) new core(".catalog-top-slider__slider", {
            modules: [ Autoplay, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".product-card__body")) {
            const thumbsSwiper = new core(".product-card-thumbs__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            new core(".product-card-slider__slider", {
                modules: [ Thumb ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
...
***************************************************************************** */
    ...
    da.init();
    if (document.documentElement.clientWidth > 768) if (document.querySelector(".product-card__info-icons")) {
